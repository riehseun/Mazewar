...
public class MazeImpl extends Maze implements Serializable, ClientListener, Runnable {
        ...
        public synchronized void addClient(Client client) {
                ...
                int pointSeed = (int) System.currentTimeMillis();
        ...
        public synchronized void addClient1(Client client) {
                assert(client != null);
                // Pick a random starting point, and check to see if it is already occupied
                //int pointSeed = (int) System.currentTimeMillis();
                //Random rand = new Random(pointSeed);
        ...
        public synchronized void addRemoteClient(Client client, Point point, Direction direction) {
                ...
                CellImpl cell = getCellImpl(point);
                cell.setContents(client);
                //System.out.println("should face " + direction);
        ...
        public synchronized boolean setPosition(Client client, DirectedPoint dp) {
            // Object o = clientMap.remove(client);
        ...
        private synchronized void killClient(Client source, Client target) {
                ...
                MazewarClientHandlerThread.respawn(source, target, point, d);
